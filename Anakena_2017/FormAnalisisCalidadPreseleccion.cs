...
namespace Anakena_2017
{
    public partial class FormAnalisisCalidadPreseleccion : Form
    {
        ...
        private void FormAnalisisCalidadPreseleccion_Load(object sender, EventArgs e)
        {
            ...
            panel1.Visible = true;
            Thread hilo = new Thread(new ThreadStart(this.CargaDatos));
            hilo.Start();
        ...
        public void CmbProducto()
        {
            ...
            {
                MessageBox.Show("Ocurrio un problema al cargar variedades "+ex, "Anakena", MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
